...
export const usersLoadingSelector = (state, props) =>
  state.users.loading[props.restaurantId];
export const usersLoadedSelector = (state, props) =>
  state.users.loaded[props.restaurantId];
